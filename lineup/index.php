...
<head>
	...
	<link rel="stylesheet" href="/assets/css/unique/<?php echo $catDirName; ?>.css" media="all">
...
<body id="<?php echo $catDirName; ?>" class="idx">
	...
	<div id="wrap">
		...
		<main>
			<div class="contents">
				<div class="main-visual">
					<div class="inner">
						<figure><img src="/assets/images/lineup/main_visual_pc.jpg" alt="ラインナップ" class="js-switch"></figure>
						<h2 class="wht" data-aos="fade-left">ラインナップ<span class="eng">LINE UP</span></h2>
					</div>
				</div>

				<section class="wide chocolate">
					<div class="inner">
						<h3 class="title" data-aos="fade-right"><span class="eng line">CHOCOLATE FLAVOR</span>チョコレート・フレーバー<span class="label">季節限定</span></h3>
						<p class="cont-txt" data-aos="fade-right">10月～5月限定のチョコレート・フレーバーは、<br>ほどよい甘さがお口の中で、サクサク食感とともに広がる上品な味わいです。</p>

						<div class="lineup">
							<figure data-aos="fade-left"><img src="/assets/images/lineup/idx_chocolate_pc.jpg" alt="" class="js-switch"></figure>

							<div class="width-fixed">
								<ul>
									<li class="row justify-content-between js-clickArea one-item">
										<div class="col-8 col-sm-12" data-aos="fade-right">
											<figure class="zoom"><img src="/assets/images/lineup/idx_salt_choco.jpg" alt="塩チョコレート"></figure>
										</div>
										<div class="col-4 col-sm-12 ex-area" data-aos="fade-left">
											<figure class="photo"><img src="/assets/images/lineup/idx_salt_choco_pkg.jpg" alt="塩チョコレート"></figure>
											<div class="text-area">
												<p class="comment">ごほうびにどうぞ</p>
												<p class="ttl"><small>塩</small>チョコレート<span class="eng">SALT DARK CHOCOLATE</span></p>
												<p class="more"><a href="/lineup/salt-dark-chocolate.php" class="arrow">LEARN MORE</a></p>
											</div>
										</div>
									</li>
									<li class="row justify-content-between js-clickArea one-item">
										<div class="col-4 col-sm-12" data-aos="fade-right">
											<figure class="photo"><img src="/assets/images/lineup/idx_salt_caramel_pkg.jpg" alt="塩キャラメルチョコレート"></figure>
											<div class="text-area">
												...
												<p class="more"><a href="/lineup/salt-caramel_blonde-chocolate.php" class="arrow">LEARN MORE</a></p>
											</div>
										</div>
										<div class="col-8 col-sm-12 order-sm-first" data-aos="fade-left">
											<figure class="zoom"><img src="/assets/images/lineup/idx_salt_caramel.jpg" alt="塩キャラメルチョコレート"></figure>
										</div>
									</li>
									<li class="row justify-content-between js-clickArea one-item">
										<div class="col-8 col-sm-12" data-aos="fade-right">
											<figure class="zoom"><img src="/assets/images/lineup/idx_matcha_choco.jpg" alt="抹茶チョコレート"></figure>
										</div>
										<div class="col-4 col-sm-12" data-aos="fade-left">
											<figure class="photo"><img src="/assets/images/lineup/idx_matcha_choco_pkg.jpg" alt="抹茶チョコレート"></figure>
											<div class="text-area">
												<p class="comment">深みが良いね</p>
												<p class="ttl"><small>抹茶</small>チョコレート<span class="eng">MATCHA WHITE CHOCOLATE</span></p>
												<p class="more"><a href="/lineup/macha-white-chocolate.php" class="arrow">LEARN MORE</a></p>
											</div>
										</div>
									</li>
								</ul>
				...
				<section class="wide flavor">
					<div class="inner">
						<h3 class="title" data-aos="fade-right"><span class="eng line">STANDARD FLAVOR</span>スタンダード・フレーバー</h3>
						<p class="cont-txt" data-aos="fade-right">ダミーのコピーです。スタンダード・フレーバーは、ティータイムにぴったりな甘味ある「はちみつトースト」や<br>お酒のおつまみにもぴったりな「おいしカレー」など、豊富な味のバリエーションをお楽しみいただけます。</p>

						<div class="lineup">
							<figure data-aos="fade-left"><img src="/assets/images/lineup/idx_standard_pc.jpg" alt="" class="js-switch"></figure>
							<div class="width-fixed">
								<ul class="row">
									<li class="col-4 col-sm-6 js-clickArea one-item" data-aos="fade-up">
										<figure class="zoom"><img src="/assets/images/lineup/idx_lineup_tomato.jpg" alt="もぎたてトマト"></figure>
										<div class="text-area">
									...
									<li class="col-4 col-sm-6 js-clickArea one-item" data-aos="fade-up" data-aos-delay="600">
										<figure class="zoom"><img src="/assets/images/lineup/idx_lineup_potato.jpg" alt="ホクホクポテト"></figure>
										<div class="text-area">
									...
									<li class="col-4 col-sm-6 js-clickArea one-item" data-aos="fade-up" data-aos-delay="900">
										<figure class="zoom"><img src="/assets/images/lineup/idx_lineup_toast.jpg" alt="はちみつトースト"></figure>
										<div class="text-area">
									...
									<li class="col-4 col-sm-6 js-clickArea one-item" data-aos="fade-up">
										<figure class="zoom"><img src="/assets/images/lineup/idx_lineup_cheese.jpg" alt="コクうまチーズ"></figure>
										<div class="text-area">
									...
									<li class="col-4 col-sm-6 js-clickArea one-item" data-aos="fade-up">
										<figure class="zoom"><img src="/assets/images/lineup/idx_lineup_corn.jpg" alt="やきたてコーン"></figure>
										<div class="text-area">
									...
									<li class="col-4 col-sm-6 js-clickArea one-item" data-aos="fade-up">
										<figure class="zoom"><img src="/assets/images/lineup/idx_lineup_curry.jpg" alt="おいしいカレー"></figure>
										<div class="text-area">
									...
									<li class="col-4 col-sm-6 js-clickArea one-item" data-aos="fade-up">
										<figure class="zoom"><img src="/assets/images/lineup/idx_lineup_brown_sugar.jpg" alt="こくとうときなこ"></figure>
										<div class="text-area">
									...
									<li class="col-4 col-sm-6 js-clickArea one-item" data-aos="fade-up">
										<figure class="zoom"><img src="/assets/images/lineup/idx_lineup_sweet_potato.jpg" alt="むらさきいも"></figure>
										<div class="text-area">
									...
									<li class="col-4 col-sm-6 js-clickArea one-item" data-aos="fade-up">
										<figure class="zoom"><img src="/assets/images/lineup/idx_lineup_soy_sauce.jpg" alt="みたらし醤油"></figure>
										<div class="text-area">
				...
				<section class="wide package">
					<div class="inner">
						...
						<p class="cont-txt" data-aos="fade-right">ライフスタイルや用途に合わせて、3種類のパッケージをご用意しました。</p>

						<div class="lineup">
							<div class="width-fixed">
								<ul class="row">
									<li class="col-6 col-sm-12 one-item" data-aos="fade-up">
										<figure><img src="/assets/images/lineup/idx_package_cube.jpg" alt="かぞくのキューブ"></figure>
										<div class="text-area">
											<p class="ttl">かぞくのキューブ</p>
											<p class="cont-txt">ちょっと小腹が空いたときに、パクっと幸せなひとくち。00g入りの小分け包装が2個入ったお手軽なパッケージです。</p>
										</div>
									</li>
									<li class="col-6 col-sm-12 one-item" data-aos="fade-up">
							...
							<ul class="row justify-content-between">
								<li class="col-12 col-sm-12 one-item">
									<div class="row no-gutters no-gutters-sm js-clickArea">
										<figure class="col-7 col-sm-12 zoom" data-aos="fade-right"><img src="/assets/images/lineup/idx_giftset.jpg" alt="ギフトセット"></figure>
					...
					<div class="width-fixed">
						<ul class="row">
							<li class="col-4 col-sm-12 one-item js-clickArea" data-aos="fade-up">
								<figure class="zoom col-sm-7"><img src="/assets/images/idx_secret.jpg" alt=""></figure>
							...
							<li class="col-4 col-sm-12 one-item js-clickArea active" data-aos="fade-up">
								<figure class="zoom col-sm-7"><span><img src="/assets/images/idx_lineup.jpg" alt=""></span></figure>
							...
							<li class="col-4 col-sm-12 one-item js-clickArea" data-aos="fade-up">
								<figure class="zoom col-sm-7"><img src="/assets/images/idx_gift.jpg" alt=""></figure>
								<div class="text-area col-sm-5">
		...
		<!-- [ GLOBAL FOOTER ] -->
		<?php include($_SERVER['DOCUMENT_ROOT'] . '/assets/parts/access.php'); ?>
		<!-- [ /GLOBAL FOOTER ] -->
