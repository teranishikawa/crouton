		...
		<main>
			<div class="contents">
                ...
                <section class="wide giftset-intro">
                    <div class="inner">
                        <div class="text-area">
                            <p class="catch">新しいジャンル「クルトンのお菓子」をギフトとして。</p>
                            <p class="cont-txt">かぞくのクルトンは、小さなお子さまからご年配の方まで、<br>幅広く楽しんでいただける多彩なフレーバーをご用意しております。<br>ブライダルの引き菓子に。出産祝いのお返しに。大切な方への贈り物に。<br>さまざまなシーンにご利用いただける、かぞくのクルトンのギフトセットをぜひご利用ください。</p>
                        </div>
                    </div>
                </section>
...
?>
                                <li class="about-noshi">
                                    <dl class="noshi-txt">
                                        <dt>のしについて</dt>
                                        <dd>のしをご希望の方に、表題入りののしを各種取り揃えております。<br class="pc">店頭にてお申しつけください。空欄ののしのご用意もございます。</dd>
                                    </dl>
