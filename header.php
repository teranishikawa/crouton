...
<head>
<meta charset="utf-8">
<meta name="description" content="<?php output_meta('description') ?>" >
<meta name="keywords" content="<?php output_meta('keyword') ?>" >
...
<link rel="apple-touch-icon" href="<?php echo get_template_directory_uri(); ?>/assets/images/sp_icon.png" />
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCkc-lsYTpGzvu5DjDj8k-lrxQFeL9HdMM&callback=initGmap" type="text/javascript"></script>
