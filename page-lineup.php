									...
									<li class="row justify-content-between js-clickArea one-item">
										...
										<div class="col-4 col-sm-12 ex-area" data-aos="fade-left">
											...
											<div class="text-area">
												...
												<p class="more"><a href="/lineup/salt-dark-chocolate/" class="arrow">LEAN MORE</a></p>
											</div>
										</div>
									</li>
									<li class="row justify-content-between js-clickArea one-item">
										<div class="col-4 col-sm-12" data-aos="fade-right">
											...
											<div class="text-area">
												...
												<p class="more"><a href="/lineup/salt-caramel_blonde-chocolate/" class="arrow">LEAN MORE</a></p>
											</div>
										</div>
									...
									<li class="row justify-content-between js-clickArea one-item">
										...
										<div class="col-4 col-sm-12" data-aos="fade-left">
											...
											<div class="text-area">
												...
												<p class="more"><a href="/lineup/macha-white-chocolate/" class="arrow">LEAN MORE</a></p>
											</div>
										</div>
									</li>
								</ul>
