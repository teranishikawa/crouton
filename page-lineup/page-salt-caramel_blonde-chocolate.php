		...
		<main>
			<div class="contents">
				<div class="main-visual">
					<div class="inner">
						<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_salted-caramel-chocolate_mv_pc.jpg" alt="塩キャラメルチョコレート" class="js-switch"></figure>
						<h2><small>おまちどうさま</small>塩キャラメルチョコレート<span class="eng">SALTED-CARAMEL-CHOCOLATE</span></h2>
					</div>
				</div>
								...
								<ul>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center">
										<div class="photo col-sm-12" data-aos="fade-right">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_salted-caramel-chocolate_01.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12" data-aos="fade-left">
											<p class="catch">おまちどうさま</p>
											<p class="cont-txt">濃厚なキャラメルチョコを、<br>
												まろやかな旨みの塩味が引き立てます。<br>
												温かいお飲み物とご一緒に、<br>
												おまちどうさまの声からはじまる時間を。</p>
										</div>
									</li>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center flex-sm-column-reverse">
										<div class="photo col-sm-12" data-aos="fade-left">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_salted-caramel-chocolate_02.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12 order-first" data-aos="fade-right">
											<p class="catch">口の中に広がるハーモニー</p>
											<p class="cont-txt">塩キャラメルチョコレート独特のやさしい甘さとほのかな塩味が、サクサクとしたクルトンの香ばしさと一緒に口の中でハーモニーを奏でます。</p>
										</div>
									</li>
								</ul>
							</div>
							...
							<div class="width-fixed">
								<ul class="row">
									<li class="col-6 col-sm-12 one-item" data-aos="fade-right">
										<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_salted-caramel-chocolate_cubebara.jpg" alt="塩キャラメルチョコレート"></figure>
									</li>
									...
									<li class="col-12 col-sm-12 one-item order-1 order-sm-2" data-aos="fade-left">
										<table class="cmn-table">
											<tbody>
												...
												<tr>
													<th>原材料</th>
													<td>小麦粉（2等粉）、てんさい糖、生イースト、シママース、脱脂粉乳、有機ショートニング、水、ブロンドチョコレート、ゲランドの塩
