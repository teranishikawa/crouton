								...
								<ul>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center">
										<div class="photo col-sm-12" data-aos="fade-right">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_macha-chocolate_01.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12" data-aos="fade-left">
											<p class="catch">抹茶の深みに心の奥までほぐされる</p>
											<p class="cont-txt">抹茶をたっぷり入れた、まろやかなホワイトチョコレート。<br>
												噛むほどに豊かな風味が広がります。<br>
												抹茶の深みが心の奥までほぐしてくれます。</p>
										</div>
									</li>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center flex-sm-column-reverse">
										<div class="photo col-sm-12" data-aos="fade-left">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_macha-chocolate_02.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12 order-first" data-aos="fade-right">
											<p class="catch">抹茶の香りと苦みがホワイトチョコと溶け合う</p>
											<p class="cont-txt">ふんだんに使われた抹茶の香りと苦味が、サクサクのクルトンを包み込むホワイトチョコレートの甘さと溶け合い、一口食べればほっと心落ち着くお菓子です。</p>
										</div>
									</li>
								</ul>
							</div>
							...
							<div class="width-fixed">
								<ul class="row align-items-center">
									<li class="col-6 col-sm-12 one-item" data-aos="fade-right">
										<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_macha-chocolate_cubebara.jpg" alt="塩キャラメルチョコレート"></figure>
									</li>
									...
									<li class="col-12 col-sm-12 one-item order-1 order-sm-2" data-aos="fade-left">
										<table class="cmn-table">
											<tbody>
												...
												<tr>
													<th>原材料</th>
													<td>小麦粉（2等粉）、てんさい糖、生イースト、シママース、脱脂粉乳、有機ショートニング、水、ホワイトチョコレート、抹茶粉末
