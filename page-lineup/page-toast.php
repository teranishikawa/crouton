		...
		<main>
			<div class="contents">
				<div class="main-visual">
					<div class="inner">
						<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_honeytoast_mv_pc.jpg" alt="はちみつトースト" class="js-switch"></figure>
						<h2><small>あなたと食べたい</small>はちみつトースト<span class="eng">HONEY TOAST</span></h2>
					</div>
				</div>
								...
								<ul>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center">
										<div class="photo col-sm-12" data-aos="fade-right">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_honeytoast_01.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12" data-aos="fade-left">
											<p class="catch">心温まる味わい</p>
											<p class="cont-txt">こんがり焼けたパン生地に、<br>
												味わい豊かなバター、はちみつをとろーり。<br>
												甘じょっぱく、心温まる味わい。<br>
												心豊かな時間を分け合って、お過ごしください。</p>
										</div>
									</li>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center flex-sm-column-reverse">
										<div class="photo col-sm-12" data-aos="fade-left">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_honeytoast_02.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12 order-first" data-aos="fade-right">
											<p class="catch">バターのコクとはちみつの甘さ</p>
											<p class="cont-txt">噛むとともにバターのコクと甘くてやさしい、はちみつの味が口の中にひろがり、クルトンのサクサク感と合間って、まさにはちみつトーストを食べているかのよう。<br>そして、隠し味のゲランドの塩が甘さをより一層引き立たせ、食べた後も、ほんのりとした甘さの後味にほっこりすることでしょう。</p>
										</div>
									</li>
								</ul>
							</div>
							...
							<div class="width-fixed">
								<ul class="row">
									<li class="col-6 col-sm-12 one-item" data-aos="fade-up">
										<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_honeytoast_cubebara.jpg" alt="はちみつトースト"></figure>
										<div class="text-area">
									...
									<li class="col-6 col-sm-12 one-item" data-aos="fade-up" data-aos-delay="300">
										<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_honeytoast_longcase.jpg" alt="かぞくのロングケース"></figure>
										<div class="text-area">
									...
									<li class="col-12 col-sm-12 one-item" data-aos="fade-left">
										<table class="cmn-table">
											<tbody>
												...
												<tr>
													<th>原材料</th>
													<td>小麦粉（2等粉）、てんさい糖、生イースト、シママース、脱脂粉乳、有機ショートニング、水、上澄みバター、RCO、はちみつ、噴霧液配合、ゲランドの塩</td>
												</tr>
												<tr>
													<th>賞味期限</th>
													<td>製造日から00日</td>
