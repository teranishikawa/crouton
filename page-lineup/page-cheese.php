		...
		<main>
			<div class="contents">
				<div class="main-visual">
					<div class="inner">
						<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_cheese_mv_pc.jpg" alt="コクうまチーズ" class="js-switch"></figure>
						<h2><small>ついつい食べちゃうよね</small>コクうまチーズ<span class="eng">CHEESE</span></h2>
					</div>
				</div>
								...
								<ul>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center">
										<div class="photo col-sm-12" data-aos="fade-right">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_cheese_01.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12" data-aos="fade-left">
											<p class="catch">次の手が伸びる</p>
											<p class="cont-txt">4種類のチーズを組み合わせた<br>
												コク深い味わい。<br>
												「ついつい食べちゃうよね」と言いながら、<br>
												次の手が伸びる楽しい場面が生まれたら嬉しいです。</p>
										</div>
									</li>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center flex-sm-column-reverse">
										<div class="photo col-sm-12" data-aos="fade-left">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_cheese_02.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12 order-first" data-aos="fade-right">
											<p class="catch">チーズ好きにはたまらないコクと旨み</p>
											<p class="cont-txt">クリーム、パルメザン、エダム、ゴーダ、4種のチーズが練り込まれたクルトンは、チーズ好きにはたまらない香り。スパイシーソルトの軽い塩味とともに、噛むほどにチーズのコクと旨味が広がります。</p>
										</div>
									</li>
								</ul>
							</div>
							...
							<div class="width-fixed">
								<ul class="row">
									<li class="col-6 col-sm-12 one-item" data-aos="fade-up">
										<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_cheese_cubebara.jpg" alt="コクうまチーズ"></figure>
										<div class="text-area">
									...
									<li class="col-6 col-sm-12 one-item" data-aos="fade-up">
										<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_cheese_longcase.jpg" alt="かぞくのロングケース"></figure>
										<div class="text-area">
									...
									<li class="col-12 col-sm-12 one-item" data-aos="fade-left">
										<table class="cmn-table">
											<tbody>
												...
												<tr>
													<th>原材料</th>
													<td>小麦粉（2等粉）、てんさい糖、生イースト、シママース、玉ねぎペースト、有機ショートニング、クリームチーズ、チーズ（パルメザン）、チーズ（エダム）、チーズ（ゴーダ）、水、てんさい糖、チーズパウダー、スパイシーソルト、オリーブオイル
													</td>
												</tr>
												<tr>
													<th>賞味期限</th>
