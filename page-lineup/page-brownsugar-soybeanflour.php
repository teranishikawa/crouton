		...
		<main>
			<div class="contents">
				<div class="main-visual">
					<div class="inner">
						<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_kinako_mv_pc.jpg" alt="こくとうときなこ" class="js-switch"></figure>
						<h2><small>いっしょに休もう</small>こくとうときなこ<span class="eng">BROWN SUGAR &amp; SOYBEAN FLOUR</span></h2>
					</div>
				</div>
								...
								<ul>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center">
										<div class="photo col-sm-12" data-aos="fade-right">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_kinako_01.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12" data-aos="fade-left">
											<p class="catch">心和む和風仕立ての味わい</p>
											<p class="cont-txt">香り豊かなきな粉と、<br>
												ミネラル豊富な黒糖の心和む和風仕立ての味わい。<br>
												大切なお相手とひとやすみにどうぞ。</p>
										</div>
									</li>
									...
									<li class="col-12 col-sm-12 one-item" data-aos="fade-left">
										<table class="cmn-table">
											<tbody>
												...
												<tr>
													<th>原材料</th>
													<td>小麦粉（2等粉）、てんさい糖、生イースト、シママース、脱脂粉乳、有機ショートニング、水、上澄みバター、黒糖、きなこ、きび糖、塩（雪塩）
