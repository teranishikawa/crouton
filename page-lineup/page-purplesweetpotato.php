		...
		<main>
			<div class="contents">
				<div class="main-visual">
					<div class="inner">
						<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_purplepotato_mv_pc.jpg" alt="むらさきいも" class="js-switch"></figure>
						<h2><small>ほっとしたい時間に</small>むらさきいも<span class="eng">PURPLE SWEET POTATO</span></h2>
					</div>
				</div>
								...
								<ul>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center">
										<div class="photo col-sm-12" data-aos="fade-right">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_purplepotato_01.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12" data-aos="fade-left">
											<p class="catch">心をやわらかくしたい時に</p>
											<p class="cont-txt">甘く、まろやかに、<br>
												心落ち着かせるむらさきいもの<br>
												おいしさを引き出しました。<br>
												ほっと一息、あなたとだれかと、<br>
												心をやわらかくしたい時にご一緒に。</p>
									...
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center flex-sm-column-reverse">
										<div class="photo col-sm-12" data-aos="fade-left">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_purplepotato_02.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12 order-first" data-aos="fade-right">
											<p class="catch">むらさきいもとはちみつ、オーガニックシュガーの自然の味わい</p>
											<p class="cont-txt">口に含めば、むらさきいもとはちみつ、オーガニックシュガーの自然な甘さがとろけます。風味をしっかり生かすため、クルトンにもむらさきいもを練り込んでいますので、噛めば噛むほど美味しさが広がります。</p>
										</div>
									</li>
								</ul>
							</div>
							...
							<div class="width-fixed">
								<ul class="row">
									<li class="col-6 col-sm-12 one-item" data-aos="fade-up">
										<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_purplepotato_cubebara.jpg" alt="こくとうときなこ"></figure>
										<div class="text-area">
									...
									<li class="col-6 col-sm-12 one-item" data-aos="fade-up" data-aos-delay="300">
										<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_purplepotato_longcase.jpg" alt="かぞくのロングケース"></figure>
										<div class="text-area">
									...
									<li class="col-12 col-sm-12 one-item" data-aos="fade-left">
										<table class="cmn-table">
											<tbody>
												...
												<tr>
													<th>原材料</th>
													<td>小麦粉（2等粉）、むらさきいもパウダー、てんさい糖、塩（シママース）、イースト、無塩バター、はちみつ、焼いもペースト、牛乳、オーガニックシュガー、無塩発酵バター、上澄みバター、粉糖、塩
