		...
		<main>
			<div class="contents">
				<div class="main-visual">
					<div class="inner">
						<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_tomato_mv_pc.jpg" alt="もぎたてトマト" class="js-switch"></figure>
								...
								<ul>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center">
										<div class="photo col-sm-12" data-aos="fade-right">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_tomato_01.jpg" alt=""></figure>
										</div>
									...
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center flex-sm-column-reverse">
										<div class="photo col-sm-12" data-aos="fade-left">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_tomato_02.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12 order-first" data-aos="fade-right">
											<p class="catch">ジュワっと広がるトマトの風味</p>
											<p class="cont-txt">トマトをパン生地に練りこんで焼き上げ、
												さらにトマト、オニオンパウダーを散りばめました。<br>
												噛めば噛むほど、トマトの酸味にオニオンの甘味がじゅわっと広がります。<br>
												そして極めつけは、スパイシーソルトと
												オリーブオイルの隠し味。<br>
												辛さとの風味が後味をより一層引き立てます。</p>
										</div>
									</li>
								</ul>
							</div>
