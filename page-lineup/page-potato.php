		...
		<main>
			<div class="contents">
				<div class="main-visual">
					<div class="inner">
						<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_potato_mv_pc.jpg" alt="ホクホクポテト" class="js-switch"></figure>
						<h2><small>ちょっとひとくち</small>ホクホクポテト<span class="eng">POTATO</span></h2>
					</div>
				</div>
								...
								<ul>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center">
										<div class="photo col-sm-12" data-aos="fade-right">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_potato_01.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12" data-aos="fade-left">
											<p class="catch">「いつの間にか食べちゃったね」</p>
											<p class="cont-txt">スパイスを効かせて旨みを引き立てたポテト。<br>噛むほどに豊かな風味が広がります。<br>「いつの間にか食べちゃったね」と<br>笑い合っていただきたいです。</p>
										</div>
									</li>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center flex-sm-column-reverse">
										<div class="photo col-sm-12" data-aos="fade-left">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_potato_02.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12 order-first" data-aos="fade-right">
											<p class="catch">ポテトのホクホクに<br>玉ねぎの甘味とエダムのコク</p>
											<p class="cont-txt">
												香ばしいクルトンからはほんのりと、練り込まれたポテトの香り。
												さらにオニオンの甘みとエダムチーズのコクをプラスしました。<br>
												隠し味はシャンピニオン(マッシュルーム)パウダー。
												スパイシーソルトのちょっぴり辛さとのアクセントでポテトが持つ素朴な風味を引き立たせています。</p>
										</div>
									</li>
								</ul>
							</div>
							...
							<div class="width-fixed">
								<ul class="row">
									<li class="col-6 col-sm-12 one-item" data-aos="fade-up">
										<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_potato_cubebara.jpg" alt="ホクホクポテト"></figure>
										<div class="text-area">
									...
									<li class="col-6 col-sm-12 one-item" data-aos="fade-up" data-aos-delay="300">
										<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_potato_longcase.jpg" alt="かぞくのロングケース"></figure>
										<div class="text-area">
									...
									<li class="col-12 col-sm-12 one-item" data-aos="fade-left">
										<table class="cmn-table">
											<tbody>
												...
												<tr>
													<th>原材料</th>
													<td>麦粉（2等粉）、てんさい糖、生イースト、シママース、玉ねぎペースト、有機ショートニング、チーズ（エダム）、ポテトフレーク、オーグル、シャンピニオンパウダー、牛乳、水、スパイシーソルト、オリーブオイル
													</td>
												</tr>
												<tr>
													<th>賞味期限</th>
