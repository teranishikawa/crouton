		...
		<main>
			<div class="contents">
				<div class="main-visual">
					<div class="inner">
						<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_curry_mv_pc.jpg" alt="おいしいカレー" class="js-switch"></figure>
						<h2><small>いただきましょう</small>おいしいカレー<span class="eng">CURRY</span></h2>
					</div>
				</div>
								...
								<ul>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center">
										<div class="photo col-sm-12" data-aos="fade-right">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_curry_01.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12" data-aos="fade-left">
											<p class="catch">やさしく煮込みました</p>
											<p class="cont-txt">みんなが大好きなカレー味。<br>りんごとはちみつで、やさしく煮込みました。<br>食卓にお揃いで、<br>どうぞお召し上がりください。</p>
										</div>
									</li>
									<li class="row no-gutters no-gutters-sm justify-content-between align-items-center flex-sm-column-reverse">
										<div class="photo col-sm-12" data-aos="fade-left">
											<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_curry_02.jpg" alt=""></figure>
										</div>
										<div class="text-area col-sm-12 order-first" data-aos="fade-right">
											<p class="catch">スパイスの効いたカレーの香りが<br class="pc">食欲をそそる</p>
											<p class="cont-txt">ひと口目にはカレー、ガーリック、スパイシーソルトのぴりっとした辛さが引き立ち、噛むほどにりんごとはちみつ、玉ねぎの甘さ、エダムチーズのコクがふわりとひろがります。塩味を抑えてちょっと甘めに仕上げていますので、誰でも気軽にカレー味を楽しめます。</p>
										</div>
									</li>
								</ul>
							</div>
							...
							<div class="width-fixed">
								<ul class="row">
									<li class="col-6 col-sm-12 one-item" data-aos="fade-up">
										<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_curry_cubebara.jpg" alt="おいしいカレー"></figure>
										<div class="text-area">
									...
									<li class="col-6 col-sm-12 one-item" data-aos="fade-up" data-aos-delay="300">
										<figure><img src="<?php echo get_template_directory_uri(); ?>/assets/images/lineup/lineup_curry_longcase.jpg" alt="かぞくのロングケース"></figure>
										<div class="text-area">
						...
						<div class="material">
							<div class="width-fixed">
								<ul class="row align-items-center">
									<li class="col-12 col-sm-12 one-item" data-aos="fade-left">
										<table class="cmn-table">
											<tbody>
												...
												<tr>
													<th>原材料</th>
													<td>小麦粉（2等粉）、てんさい糖、はちみつ、りんごジュース、生イースト、シママース、玉ねぎペースト、有機ショートニング、チーズ（エダム）、カレーパウダー&#9312;、カレーパウダー&#9313;、水、オニオンパウダー、ガーリックパウダー、スパイシーソルト、オリーブオイル</td>
												</tr>
												<tr>
													<th>賞味期限</th>
													<td>製造日から00日</td>
					...
					<div class="width-fixed">
						<ul class="row">
							<li class="col-4 col-sm-12 one-item js-clickArea" data-aos="fade-up">
								<figure class="zoom"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/idx_secret.jpg" alt=""></figure>
								<div class="text-area">
							...
							<li class="col-4 col-sm-12 one-item js-clickArea active" data-aos="fade-up">
								<figure class="zoom"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/idx_lineup.jpg" alt=""></figure>
								<div class="text-area">
							...
							<li class="col-4 col-sm-12 one-item js-clickArea" data-aos="fade-up">
								<figure class="zoom"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/idx_gift.jpg" alt=""></figure>
								<div class="text-area">
